...
// Package provide useful namespaces for us to declare similar classes with the correct name
...
public class Person {
    ...
    If we remember, methods are like reusable chunks of code and they generally represent what an object can do
    ...
    /*
    Before we go too far I'm going to add onto our constructor notes from before by creating additional constructors
